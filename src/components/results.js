...
class Results extends Component {
  ...
  render(){
    return(
      <div>
        <span className="label">Angular: {this.votesAngularInPercent().toFixed(2) + '%'}</span>
        <div className="progress">
          <div className="progress-bar progress-bar-success" style={this.votesAngularInPercentStyle()}>
          </div>
        </div>
        ...
        <span className="label label-danger">Vue.js: {this.votesVuejsInPercent().toFixed(2) + '%'}</span>
        <div className="progress progress-striped active">
